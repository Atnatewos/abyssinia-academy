 ...
 * 
 * NO internal phase grid. All phase selection is on /courses/[slug]
 *
...
const PortalPage = () => {
  ...
  /**
   * Navigate back to the course detail page showing PhaseCard components.
   * This is the ONLY place phase cards exist - on /courses/[slug]
   */
