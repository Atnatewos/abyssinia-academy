 ...
 * Displays a single phase with outcomes, duration, and classroom link
    ...
    <div className="phase-card" style={{ animationDelay: `${index * 100}ms` }}>
      ...
      <div>
        <div className="phase-card-header">
          <span className="phase-card-number">Phase {phase.phase_number}</span>
            ...
            <ul className="phase-card-outcomes-list">
              {phase.outcomes.map((outcome, idx) => (
                <li key={idx} className="phase-card-outcome">
                  <Check /><span>{typeof outcome === 'string' ? outcome : outcome.text}</span>
                </li>
              ))}
            </ul>
          </div>
      ...
      <div className="phase-card-bottom">
        <span className="phase-card-module">Phase {phase.phase_number} Module</span>
